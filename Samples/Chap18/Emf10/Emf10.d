...
string szClass     = "EMF10";
string szTitle     = "EMF10: Enhanced Metafile Demo #10";
string appName     = "EMF";
string description = "EMF10: Enhanced Metafile Demo #10";
HINSTANCE hinst;
...
void PaintRoutine(HWND hwnd, HDC hdc, int cxArea, int cyArea)
{
    ...
    hemf = GetEnhMetaFile("..\\emf8\\emf8.emf");
    ...
    fScale = min(cast(float)cxArea / cxImage, cast(float)cyArea / cyImage);

    cxImage = cast(int)(fScale * cxImage);
    cyImage = cast(int)(fScale * cyImage);
